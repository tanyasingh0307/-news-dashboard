...
🔗 Backend API: https://your-backend-url.vercel.app *(replace with your actual deployed URL)*

> Both frontend and backend are now deployed. Login, signup, and bookmarks
> work directly on the live demo — no local setup required to try it out.
